package cn.devops.service.impl.codeGenerate.html;
...
public class HTMLGenerator implements IGenerator {
	...
	public void execute(IFile erdFile, RootModel root, GraphicalViewer viewer,String empty,RootModel qryRoot,RootModel auRoot,RootModel valiRoot) {
		try {
	...
	public void generate(String rootDir, RootModel root) throws Exception {
		/*IOUtils.copyStream(ViewClassRootPath.class.getResourceAsStream("output/html/stylesheet.css"), new FileOutputStream(new File(rootDir,
				"output/html/stylesheet.css")));*/
		...
		processTemplate("output/html/summary.html", new File(rootDir, "index.html"), context);
		processTemplate("output/html/list.html", new File(rootDir, "list.html"), context);
		processTemplate("output/html/table.html", new File(rootDir, "summary.html"), context);

		File imageDir = new File(rootDir, "images");
		imageDir.mkdir();

		IOUtils.copyStream(ViewClassRootPath.class.getResourceAsStream("output/html/primarykey.gif"), new FileOutputStream(new File(imageDir,
				"primarykey.gif")));
		...
		for (TableModel table : root.getTables()) {
			...
			processTemplate("output/html/table.html", new File(tableDir, table.getTableName() + ".html"), context);
		}
	}
