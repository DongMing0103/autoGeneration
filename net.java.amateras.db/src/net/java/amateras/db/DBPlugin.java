...
public class DBPlugin extends AbstractUIPlugin {
	...
	public static final String ID = "net.java.amateras.db";
	 ...
	 * If <code>ImageRegistry</code> already has cached <code>Image</code>, this
	 * method returns cached <code>Image</code>.
	 * <p>
				...
				for (int j = 0; j < elements.length; j++) {
					try {
						if ("dialect".equals(elements[j].getName())) {
							...
							IDialect dialect = (IDialect) elements[j]
