...
public abstract class AbstractDialect implements IDialect {
	...
	public String createTableDDL(RootModel root, TableModel model, boolean schema, boolean drop, boolean alterTable, boolean comment,
		...
		sb.append("CREATE TABLE ").append(getTableName(root, model, schema)).append("(" + LS);
		...
		if (alterTable && primaryKeys.length != 0) {
			...
			pkBuf.append("ALTER TABLE ").append(getTableName(root, model, schema));
	...
	protected String createColumnDDL(RootModel root, TableModel tableModel, ColumnModel columnModel, boolean schema, boolean alterTable,
			StringBuilder additions, boolean comment) {
		StringBuffer sb = new StringBuffer();
	...
	protected void setupTableOption(RootModel root, TableModel model, boolean schema, boolean drop, boolean alterTable, boolean comment,
