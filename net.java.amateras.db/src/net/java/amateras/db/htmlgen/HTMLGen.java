...
public class HTMLGen {
	...
	private void processTemplate(String templateName, File output, VelocityContext context) throws Exception {
		...
		InputStreamReader reader = new InputStreamReader(
				HTMLGen.class.getResourceAsStream(templateName), "UTF-8");
	...
	public void generate(String rootDir, RootModel root) throws Exception {
		IOUtils.copyStream(HTMLGen.class.getResourceAsStream("stylesheet.css"),
		...
		IOUtils.copyStream(HTMLGen.class.getResourceAsStream("primarykey.gif"),
