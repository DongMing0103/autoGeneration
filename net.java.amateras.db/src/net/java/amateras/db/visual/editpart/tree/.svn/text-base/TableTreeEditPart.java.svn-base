...
public class TableTreeEditPart extends AbstractDBTreeEditPart {
	...
	/**
	 * A <code>CompositeImageDescriptor</code> implementation to create overlay
	 * icon.
	 */
	...
	protected List<Object> getModelChildren() {
		...
		list.add(new FolderModel(DBPlugin.getResourceString("label.index"), null) {
			...
			public void doEdit() {
				...
				TableEditPart.openTableEditDialog(getViewer(), table, (RootModel) getRoot().getContents().getModel(), (IndexModel) null);
