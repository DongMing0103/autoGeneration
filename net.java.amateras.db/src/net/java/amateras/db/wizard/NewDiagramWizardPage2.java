...
public class NewDiagramWizardPage2 extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		Label lab1 = new Label(container, SWT.NONE);
		lab1.setText("jar:");

		jarFile = new Text(container, SWT.BORDER | SWT.SINGLE);
		jarFile.setEditable(false);
		GridData gd_jarFile = new GridData(GridData.FILL_HORIZONTAL);
		gd_jarFile.horizontalSpan = 3;
		jarFile.setLayoutData(gd_jarFile);
		...
		Label af = new Label(container, SWT.READ_ONLY);
		af.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
		af.setText("驱动");

		driver = new Combo(container, SWT.READ_ONLY);
		driver.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 5, 1));
		...
		// -------------
		Label url_1 = new Label(container, SWT.NONE);
		url_1.setText("url:");

		databaseURI = new Text(container, SWT.BORDER | SWT.SINGLE);
		databaseURI.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 5, 1));
		...
		schema.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 3, 1));
		// -------------

		Label catalogLabel = new Label(container, SWT.NONE);
		catalogLabel.setText("catalog:");

		catalog = new Text(container, SWT.BORDER | SWT.SINGLE);
		catalog.setText("");
		catalog.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));

		Label filterLabel = new Label(container, SWT.NONE);
		filterLabel.setText("filter:");

		filter = new Text(container, SWT.BORDER);
		GridData gd_filter = new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1);
		gd_filter.widthHint = 173;
		...
		Label viewLabel = new Label(container, SWT.NONE);
		...
		tablesLabel.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 2));
		tablesLabel.setText("tables:");

		list = new List(container, SWT.BORDER | SWT.MULTI | SWT.V_SCROLL);
		GridData gd_list = new GridData(SWT.FILL, SWT.CENTER, false, false, 4, 2);
		gd_list.heightHint = 127;
		list.setLayoutData(gd_list);

		// ----------------
		autoConvert = new Button(container, SWT.CHECK);
		autoConvert.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 2));
		autoConvert.setText("autoConvert");
	...
	private void loadJdbcDriver() {
		try {
			...
			System.out.println("load db ...." + clspath);
	...
	public void importTables(RootModel root) throws SQLException {
		...
		try {
			conn = dbinfo.connect();
			loader.loadSchema(root, DialectProvider.getDialect(root.getDialectName()), conn, list.getSelection(), dbinfo.getCatalog(),
